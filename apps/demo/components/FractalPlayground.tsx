                ...
                <AccordionContent className="px-4 pb-4 space-y-4">
                  <div className="space-y-1.5">
                    <Select
                      value={fractalType}
                      onValueChange={(value) =>
                        handleFractalTypeChange(value as FractalType)
                      }
                    >
                      <SelectTrigger>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="hilbert">Hilbert Curve</SelectItem>
                        <SelectItem value="levy">Lévy C Curve</SelectItem>
                        <SelectItem value="sierpinski">
                          Sierpinski Triangle
                        </SelectItem>
                        <SelectItem value="peano">Peano Curve</SelectItem>
                        <SelectItem value="gosper">Gosper Curve</SelectItem>
                  ...
                  {(fractalType === "mandelbrot" ||
                    ...
                    <>
                      <div className="space-y-1.5">
                        <div className="flex justify-between">
                          <Label>Contour Bands</Label>
                          <span className="text-sm text-muted-foreground">
                            {(options as any).numBands}
                          </span>
                        </div>
                        <Slider
                          min={4}
                          max={40}
                          step={1}
                          value={[(options as any).numBands]}
                          onValueChange={([value]) =>
                            updateOption("numBands", value)
                          }
                        />
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <Slider
                          ...
                          max={500}
                          step={10}
                          value={[(options as any).maxIter]}
                          onValueChange={([value]) =>
                            updateOption("maxIter", value)
                          }
                        />
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <Slider
                          ...
                          max={8}
                          step={0.1}
                          value={[(options as any).zoom]}
                          onValueChange={([value]) =>
                            updateOption("zoom", value)
                          }
                        />
                      </div>
                        ...
                        <div className="space-y-1.5">
                          <div className="flex justify-between">
                            ...
                            <span className="text-xs text-muted-foreground">
                              {(options as any).centerX.toFixed(2)}
                            </span>
                          </div>
                          <Slider
                            min={-2.5}
                            max={1.5}
                            step={0.05}
                            value={[(options as any).centerX]}
                            onValueChange={([value]) =>
                              updateOption("centerX", value)
                            }
                          />
                        </div>
                        <div className="space-y-1.5">
                          <div className="flex justify-between">
                            ...
                            <span className="text-xs text-muted-foreground">
                              {(options as any).centerY.toFixed(2)}
                            </span>
                          </div>
                          <Slider
                            min={-2}
                            max={2}
                            step={0.05}
                            value={[(options as any).centerY]}
                            onValueChange={([value]) =>
                              updateOption("centerY", value)
                            }
                          />
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1.5">
                        <div className="flex justify-between">
                          <Label>c (Real)</Label>
                          <span className="text-xs text-muted-foreground">
                            {(options as any).juliaReal.toFixed(3)}
                          </span>
                        </div>
                        <Slider
                          min={-2}
                          max={2}
                          step={0.005}
                          value={[(options as any).juliaReal]}
                          onValueChange={([value]) =>
                            updateOption("juliaReal", value)
                          }
                        />
                      </div>
                      <div className="space-y-1.5">
                        <div className="flex justify-between">
                          <Label>c (Imag)</Label>
                          <span className="text-xs text-muted-foreground">
                            {(options as any).juliaImag.toFixed(3)}
                          </span>
                        </div>
                        <Slider
                          min={-2}
                          max={2}
                          step={0.005}
                          value={[(options as any).juliaImag]}
                          onValueChange={([value]) =>
                            updateOption("juliaImag", value)
                          }
                        />
                      </div>
                    </div>
                ...
                <AccordionContent className="px-4 pb-4 space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="circle-bg">Circle Backdrop</Label>
                      <Switch
                        id="circle-bg"
